...
const translations = {
  mr: {
    ...
    nav_exchange: 'बदली ऑफर',
    nav_contact: 'संपर्क',
    hero_badge: 'विश्वासार्ह आणि तत्पर सेवा',
    ...
    stat_discharge: 'पाण्याचा वाहन दर',
    stat_virgin: 'नवीन साहित्य',
    stat_isi: 'Non-ISI सुद्धा',
    about_tag: 'Dinesh Enterprises',
    about_title: 'दिनेश ठिबक सिंचन प्रणाली',
    about_desc: 'माळेगाव बु., बारामती (जि. पुणे) येथे स्थित — शेतकऱ्यांसाठी गुणवत्तापूर्ण ठिबक सिंचन उपकरणे आणि सेवा. आधुनिक तंत्रज्ञान, उच्च दर्जाचे साहित्य आणि विश्वासार्ह सेवा.',
    ah1_title: 'उत्पादक',
    ...
    f1_title: 'उच्च दर्जाचे साहित्य',
    f1_desc: 'टिकाऊ, उच्च दर्जाचे साहित्य आणि चार छिद्र असलेले वालू-रोधक ठिबक यंत्र. अत्याधुनिक तंत्रज्ञान आणि यंत्रसामग्री.',
    f2_title: 'कमी दाबात कार्यक्षम',
    f2_desc: 'कमी दाब आणि गढळ/अशुद्ध पाण्यासाठी योग्य. चार छिद्र ठिबक यंत्रामुळे बंद होण्याची शक्यता कमी.',
    f3_title: 'बचत आणि जास्त उत्पादन',
    f3_desc: 'पाणी, खते, कीटकनाशके, मजुरी आणि बियाणे यामध्ये मोठी बचत — पिकाचे उत्पादन वाढते.',
    f5_title: 'फिल्टरशिवाय सिस्टम',
    f5_desc: 'सोपी बांधणी, कमी देखभाल — फिल्टरशिवायही उत्तम कार्यक्षमता.',
    system_tag: 'पूर्ण सिंचन उपाय',
    system_title: 'संपूर्ण ठिबक सिंचन — मुळाशी अचूक पाणी',
    system_desc: 'शेताच्या जमिनीचा उतार, पाण्याचा दाब, पिकाचा प्रकार आणि रांगांचे अंतर पाहून योग्य ठिबक सिंचन प्रणाली निवडली जाते. उद्देश सोपा आहे — पाणी थेट मुळाशी, कमी वाया जाणे, आणि पिकाला नियमित ओलावा.',
    sb1: 'मुळाशी सिंचन',
    ...
    flow1: 'पाण्याचा स्रोत',
    flow1_desc: 'विहीर / बोअर / टाकी',
    flow2: 'फिल्टर व मुख्य नळी',
    flow2_desc: 'स्वच्छ पाणी आणि दाब नियंत्रण',
    flow3: 'ठिबक नळी व यंत्र',
    flow3_desc: 'रांगेनुसार ठिबक नळी',
    flow4: 'पिकाची मुळे',
    flow4_desc: 'मुळाशी नियमित ओलावा',
    comp1: 'ठिबक नळी',
    comp1_desc: 'शेतातील रांगांसाठी 12, 16, 20 mm नळी.',
    comp2: 'ठिबक यंत्र',
    comp2_desc: 'पिकाच्या गरजेनुसार 2, 4, 8 लिटर/तास वाहन दर.',
    comp3: 'फिल्टर व वाल्व',
    comp3_desc: 'चांगला प्रवाह, स्वच्छ पाणी आणि सोपे विभाग नियंत्रण.',
    comp4: 'जोडण्या व उपसाधने',
    comp4_desc: 'कनेक्टर, व्हेंच्युर, जोडण्या आणि शेतात दुरुस्ती सेवा.',
    crops_tag: 'पिकानुसार उपाय',
    crops_title: 'प्रत्यक्ष शेतासाठी सिंचन प्रणाली',
    crops_desc: 'ऊस, भाजीपाला, फळबाग आणि इतर पिकांसाठी योग्य अंतर, वाहन दर आणि नळी मांडणी निवडण्यात मदत.',
    crop1_tag: 'विशेष',
    crop1: 'ऊस ठिबक सिंचन',
    crop1_desc: 'कमी दाबात चालणारी नळी, 8 लिटर/तास पर्यंत वाहन दर आणि ऊसासाठी मजबूत नळी पर्याय.',
    crop2_tag: 'अचूक',
    crop2: 'भाजीपाला व रांग पिके',
    crop2_desc: '20–50 cm अंतर, मुळाशी नियमित ओलावा आणि पाण्याचा नियंत्रित वापर.',
    crop3_tag: 'दीर्घकाळ टिकणारे',
    crop3: 'फळबाग व बाग',
    crop3_desc: 'फळबाग, द्राक्ष, फुले आणि रोपवाटिकेसाठी स्थिर पाणीपुरवठा.',
    ...
    pc1_note: 'उत्तम दर्जाची यंत्रसामग्री, आधुनिक तंत्रज्ञान, उच्च दर्जाचे कच्चे दाणे.',
    pc2_tag: 'फ्लॅट ठिबक टेप',
    pc2_note: 'उत्तम दर्जाची यंत्रसामग्री, आधुनिक तंत्रज्ञान, 100% नवीन साहित्य.',
    pc3_title: 'इतर सिस्टम',
    pc3_tag: 'सर्व पिकांसाठी',
    cmp1_title: 'Hydrogoal — गोल ठिबक नळी',
    cmp1_desc: 'मजबूत गोल नळी, 2 / 4 / 8 लिटर/तास वाहन दर.',
    cmp2_title: 'Flat Drip — फ्लॅट ठिबक टेप',
    cmp2_desc: 'पातळ भिंतीची टेप, 2 / 4 लिटर/तास वाहन दर.',
    spec_sizes: 'आकार',
    spec_spacing: 'अंतर',
    spec_discharge: 'वाहन दर',
    ...
    exchange_desc: 'तुमच्या जुन्या ठिबक नळी आणा आणि नवीन, गुणवत्तापूर्ण नळी स्वस्त दरात मिळवा. ऊस पिकासाठी विशेष — फिल्टरशिवाय, 8 लिटर/तास वाहन दर उपलब्ध.',
    exchange_cta: 'आता संपर्क साधा',
    process_tag: 'आमची कामाची पद्धत',
    process_title: 'शेत पाहणीपासून सिंचन बांधणीपर्यंत',
    process_desc: 'फक्त माल विक्री नाही — शेतातील गरज समजून योग्य सिंचन प्रणाली बसवण्यावर भर.',
    ps1: 'शेत पाहणी',
    ps1_desc: 'पिक, जमीन, पाणी स्रोत आणि दाब समजून घेणे.',
    ps2: 'प्रणाली निवड',
    ps2_desc: 'Hydrogoal, Flat Drip, अंतर आणि वाहन दर निवड.',
    ps3: 'बांधणी',
    ps3_desc: 'नळी, जोडण्या, फिल्टर, वाल्व आणि शेत मांडणी बांधणी.',
    ps4: 'बांधणीनंतर सेवा',
    ps4_desc: 'वापर, देखभाल आणि दुरुस्तीसाठी मार्गदर्शन.',
    contact_tag: 'संपर्क',
  ...
  en: {
    ...
    hero_title: 'Dinesh Drip Irrigation',
    ...
    stat_virgin: 'New Material',
    stat_isi: 'Also Non-ISI',
    about_tag: 'Dinesh Enterprises',
    ...
    f2_desc: 'Suitable for low pressure and muddy or sediment-heavy water. Four-hole dripper design significantly reduces clogging.',
    ...
    pc2_note: 'Premium machinery, modern technology, 100% new material.',
    ...
    contact_address_en: 'Near Malegaon Engineering College, Malegaon B.K., Baramati, Dist. Pune 413115',
    contact_fb: 'Dinesh Drip Irrigation — Baramati',
    form_name: 'Name',
